...
def build(df):
    ...
    sig={
      ...
      "S14_break_lowvol":(c("close")>c("hi20"))&(c("atrpct")<c("atrpct").rolling_quantile(60,0.40)),
      ...
      "S35_atr_compress_break":(c("atrpct")<c("atrpct").rolling_quantile(60,0.25))&(c("close")>c("hi20")),
